...
#include <unordered_map>
    ...
    {
      public:
        std::unordered_map<input_key, input_device_state> get_keyboard_state(int index) { return _keyboardState; }
        std::unordered_map<input_key, input_device_state> get_mouse_state(int index) { return _mouseState; }
      ...
      private:
        std::unordered_map<input_key, input_device_state> _keyboardState{};
        std::unordered_map<input_key, input_device_state> _mouseState{};
    };